...
export default function FullscreenControls({
  ...
  return (
    <>
      {/* Подсказка с плавным исчезновением */}
      <div className={`absolute top-8 left-1/2 -translate-x-1/2 px-4 py-2 bg-black/50 backdrop-blur-sm rounded-full text-white text-sm transition-opacity duration-500 ${
        showHint ? 'opacity-100' : 'opacity-0 pointer-events-none'
      }`}>
        Нажмите на видео для переключения между вами и собеседником
      </div>
